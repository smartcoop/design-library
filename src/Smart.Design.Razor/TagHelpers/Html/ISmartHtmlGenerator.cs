...
namespace Smart.Design.Razor.TagHelpers.Html
{
    ...
    public interface ISmartHtmlGenerator
    {
        ...
        TagBuilder GenerateSmartRadio(string id, string name, string label, string value, bool @checked,
            ModelExpression @for);
        ...
        TagBuilder GenerateSmartTextArea(string id, string name, TagHelperContent value, int? rows,
            TextAreaSize textareaSize, ModelExpression @for);
