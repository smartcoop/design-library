...
/// </para>
/// </summary>
[HtmlTargetElement(TagNames.InputDateName, TagStructure = TagStructure.NormalOrSelfClosing)]
public class InputDateTagHelper: BaseTagHelper
{
    ...
    public InputDateTagHelper(IInputHtmlGenerator inputHtmlGenerator)
    {
    ...
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        var input = _inputHtmlGenerator.GenerateInputDate(ViewContext, Id, Name, Placeholder, Value, For);
