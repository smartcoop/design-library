...
try {
  var projectConfig = require('../../bedrock.config');

  config = _objectSpread(_objectSpread({}, defaultConfig), projectConfig);
} catch (err) {
  console.log(err);
...
},{"../../bedrock.config":1,"./default-config":3}],3:[function(require,module,exports){
"use strict";
...
try {
  var savedState = JSON.parse(localStorage.getItem(NAV_STATE_STORAGE_KEY));
...
},{"../../package.json":25,"../discovery/config":2,"jquery":22}],6:[function(require,module,exports){
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
    ...
    var $SmartCompBlocks = (0, _jquery.default)('.br-sample-content'); 
...
if (_config.default.styleguide) {
  ...
  (0, _jquery.default)('.br-sample-show-code-btn-csharp').on('click', function (e) {
    if ((0, _jquery.default)(this).parents('.br-sample').find('.br-sample-code-csharp').is(':visible')) {
      (0, _jquery.default)(this).parents('.br-sample').find('.br-sample-code-csharp').hide();
    } else {
      (0, _jquery.default)(this).parents('.br-sample').find('.br-sample-code-csharp').show();
    }
  });
...
},{"../discovery/config":2,"clipboard":11,"codemirror":12,"codemirror/mode/pug/pug":16,"codemirror/mode/xml/xml":17,"jquery":22}],7:[function(require,module,exports){
"use strict";
...
var scrollPositions; // Load selector map from storage, or create a new one
...
var typographyEntries = document.querySelectorAll('#component-typography tbody tr');

function calculateFontSizes() {
  typographyEntries.forEach(function (element) {
    var fontSizeInfo = element.querySelector('.br-typography-sample-size');
    var fontSizeForElement = getComputedStyle(element.querySelector('.br-typography-sample-content').children[0])['font-size'];
...
},{"select":23}],11:[function(require,module,exports){
(function (global, factory) {
    if (typeof define === "function" && define.amd) {
...
},{"./clipboard-action":10,"good-listener":21,"tiny-emitter":24}],12:[function(require,module,exports){
...
},{"../../lib/codemirror":12,"../css/css":13,"../javascript/javascript":15,"../xml/xml":17}],15:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: https://codemirror.net/LICENSE
...
},{"../../lib/codemirror":12,"../css/css":13,"../htmlmixed/htmlmixed":14,"../javascript/javascript":15}],17:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: https://codemirror.net/LICENSE
...
},{"./closest":18}],20:[function(require,module,exports){
/**
...
},{"./is":20,"delegate":19}],22:[function(require,module,exports){
/*!
